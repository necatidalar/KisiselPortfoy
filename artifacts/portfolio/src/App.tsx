...
const services = [
  {
    ...
    description: "Kurumsal, kişisel veya özel ihtiyaçlara yönelik modern web siteleri."
  },
  {
    icon: Terminal,
    title: "Web Uygulaması Geliştirme",
    description: "Yönetim panelleri, dashboardlar, SaaS projeleri ve özel web uygulamaları."
  },
  {
    icon: Database,
    title: "Backend & API Geliştirme",
    description: "Güvenli, hızlı ve ölçeklenebilir backend sistemleri ve API servisleri."
  },
  {
    icon: Smartphone,
    title: "Mobil Uygulama Geliştirme",
    description: "iOS ve Android uyumlu modern mobil uygulama çözümleri."
  },
  {
    icon: Wrench,
    title: "Bakım ve Teknik Destek",
    description: "Mevcut projelerin iyileştirilmesi, hata giderme ve performans optimizasyonu."
  }
];
          ...
          <div className="container mx-auto max-w-5xl relative z-10 flex flex-col items-center text-center">
            ...
            >
              <motion.div variants={fadeIn} className="inline-flex items-center space-x-2 bg-white/5 border border-white/10 rounded-full px-4 py-1.5 mb-8">
                ...
                <span className="text-xs font-mono text-muted-foreground">Şu an yeni projelere açık</span>
              </motion.div>

              <motion.h1 variants={fadeIn} className="text-5xl md:text-7xl lg:text-8xl font-extrabold tracking-tight mb-6 text-white">
                Merhaba, ben <br className="md:hidden" /><span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-orange-400">Ahmet Yılmaz</span>
              </motion.h1>
              
              <motion.p variants={fadeIn} className="text-xl md:text-2xl text-muted-foreground max-w-3xl mb-4 font-light">
                Yazılım geliştirici olarak web, mobil ve özel yazılım çözümleri geliştiriyorum.
              </motion.p>
              
              <motion.p variants={fadeIn} className="text-lg text-muted-foreground/80 max-w-2xl mb-12">
                Modern, performanslı ve kullanıcı odaklı dijital ürünler tasarlıyor ve geliştiriyorum. Her satır kodda kalite ve hızı ön planda tutuyorum.
              </motion.p>
              ...
              <motion.div variants={fadeIn} className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                <Button size="lg" className="text-base h-14 px-8 glow-primary" onClick={() => scrollTo('projeler')}>
                  Projelerimi Gör <ChevronRight className="ml-2 h-4 w-4" />
                </Button>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            >
              <motion.div variants={fadeIn} className="space-y-6">
                ...
                <h3 className="text-3xl md:text-4xl font-bold text-white">Zanaatkarlık ve Teknolojinin Kesişimi</h3>
                <div className="space-y-4 text-muted-foreground text-lg leading-relaxed">
                  <p>
                    Yazılım geliştirmeyi sadece kod yazmak olarak değil, problemleri zarif çözümlere kavuşturan dijital bir zanaatkarlık olarak görüyorum. Yılların verdiği deneyimle, karmaşık sistemleri kullanıcı dostu arayüzlere dönüştürüyorum.
                  </p>
                  <p>
                    Çalışma felsefem; <strong className="text-white font-medium">temiz kod</strong>, <strong className="text-white font-medium">performans</strong>, <strong className="text-white font-medium">ölçeklenebilirlik</strong> ve kusursuz bir <strong className="text-white font-medium">kullanıcı deneyimi</strong> üzerine kuruludur.
                  </p>
                </div>
              </motion.div>
              ...
              <motion.div variants={fadeIn} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  "Mobil Uygulama", "API Entegrasyonları", 
                  "Veritabanı Tasarımı", "Özel Yazılım Çözümleri"
                ].map((skill, index) => (
                ...
                <div className="space-y-6">
                  <div className="flex items-center space-x-4 text-muted-foreground hover:text-white transition-colors">
                    ...
                    <div>
                      ...
                      <a href="mailto:hello@ahmetyilmaz.dev" className="font-mono text-lg">hello@ahmetyilmaz.dev</a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4 text-muted-foreground hover:text-white transition-colors">
                    ...
                    <div>
                      ...
                      <a href="tel:+905551234567" className="font-mono text-lg">+90 (555) 123 45 67</a>
                    </div>
                  </div>
                ...
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <Button type="submit" className="w-full h-12 text-base font-medium glow-primary" disabled={form.formState.isSubmitting}>
                      {form.formState.isSubmitting ? "Gönderiliyor..." : (
      ...
      <footer className="py-8 border-t border-white/5 bg-background text-center md:text-left">
        <div className="container mx-auto px-6 max-w-6xl flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-sm text-muted-foreground font-mono">
            © 2026 Ahmet Yılmaz. Tüm hakları saklıdır.
          </p>
          
          <div className="flex items-center space-x-4">
            <a href="#" className="text-muted-foreground hover:text-white transition-colors p-2 hover:bg-white/5 rounded-full">
              <Github className="h-5 w-5" />
            </a>
            <a href="#" className="text-muted-foreground hover:text-[#0077b5] transition-colors p-2 hover:bg-white/5 rounded-full">
